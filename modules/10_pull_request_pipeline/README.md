...
In this stage we'll be using [Github Actions](https://docs.github.com/en/actions/learn-github-actions/understanding-github-actions) to create a pull request pipeline that will run your tests and lint your project on each [pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/about-pull-requests) made to your repository. A pipeline in Github Actions is called a [workflow](https://docs.github.com/en/actions/using-workflows/about-workflows).
...
4. Create a `.github/workflows` folder in the root of the project
    ...
    > For Github to recognize a workflows, it must be defined in the `.github/workflows` directory in a repository. You can have multiple workflows, each of which can perform a different set of tasks.
